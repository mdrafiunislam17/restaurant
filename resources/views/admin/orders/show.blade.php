            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="order_date" name="order_date" value="{{ $order->order_date ? \Carbon\Carbon::parse($order->order_date)->format('Y-m-d') : '' }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" step="0.01" class="form-control" id="total_amount" name="total_amount" value="{{ $order->total_amount }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="delivery_address" id="delivery_address" class="form-control" disabled>{{ $order->delivery_address }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="time" class="form-control" id="pickup_time" name="pickup_time" value="{{ $order->pickup_time }}" disabled>
                        </div>
                    </div>
