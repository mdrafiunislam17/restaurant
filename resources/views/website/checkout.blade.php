                                ...
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="form-outline">
                                            <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Type here"
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="form-outline">
                                            <textarea id="address" name="address" placeholder="Type here"
                                    ...
                                    <div class="col-sm-12 mb-3 mt-5">
                                        ...
                                        <div class="form-outline">
                                            <textarea id="note" name="note" placeholder="Type here"
                                    ...
                                    <div class="col-12">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="radio" name="payment_method"
                                                   id="cash_on_delivery" value="Cash On Delivery" @checked('Cash On Delivery' == old('payment_method')) required />
                                            <label class="form-check-label" for="cash_on_delivery">
                                                <img src="{{asset("asset/images/c2.png")}}" alt="Cash on Delivery"
                                                     height="20"> Cash on delivery
                                            </label>
                                        </div>

                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="radio" name="payment_method"
                                                   id="bkash" value="bKash"  @checked('bKash' == old('payment_method')) required/>
                                            <label class="form-check-label" for="bkash">
                                                <img src="{{asset("asset/images/c2.png")}}" alt="bKash"
                                                     height="20"> bKash ({{ Helper::BKASH_NUMBER }})
                                            </label>
                                        </div>
                                    </div>
