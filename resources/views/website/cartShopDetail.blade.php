            ...
            <nav class="navbar navbar-expand-lg custom_nav-container">
                <ul class="navbar-list" style="margin-top: -60px; font-size: 20px;">
                    <li class="navbar-item">
                        <a class="nav-link text-white" href="{{route('website.home')}}">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="navbar-item">
                        <a class="nav-link text-white" href="{{route('website.menu')}}">Menu</a>
                    </li>
                    <li class="navbar-item">
                        <a class="nav-link text-white" href="{{route('website.about')}}">About</a>
                    </li>
                    <li class="navbar-item">
                        <a class="nav-link text-white" href="{{route('website.bookTable.blade.php')}}">Book Table</a>
                    </li>
                </ul>
...
<div class="container mt-3">
    ...
    <table class="">
        <thead class="table-success custom_table">
        <tr>
            <th>IMAGE</th>
            <th>NAME</th>
            <th>PRICE</th>
        ...
        <form action="" method="POST">
            ...
            <tr>
                ...
                <td class="image" data-title="No" style="padding-left: 95px;">
                    <img src="{{asset('asset/images/pizza-img-1.png')}}" class="img-fluid product-image" alt="">
                </td>
                <td class="menuItem-des" data-title="Description" style="padding-left: 90px;">
                    <p class="menuItem-name">Rafiun</p>
                </td>
                <td class="price" data-title="Price" style="padding-left: 130px;">
                    <span>$100</span>
                </td>
                <td class="qty" data-title="Qty" style="padding-left: 120px;">
                    <!-- Input Order -->
                ...
                <td class="total-amount cart_single_price" data-title="Total" style="padding-left: 100px;">
                    <span class="money">$1100</span>
                </td>
                <td class="action" data-title="Remove" style="padding-left: 130px;">
    ...
    <div class="row" style="padding-left: 900px">
        <div class="col-10 ">
            ...
            <div class="total-amount">
                <div class="row">
                    <ul>
                        <li class="order_subtotal" >Cart Subtotal $100</li>
                        <hr style="height: 4px; width: 160px;">
                        <li class="coupon_price" >You Pay $4000</li>
